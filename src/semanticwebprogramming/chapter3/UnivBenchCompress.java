...
public class UnivBenchCompress {
	static String baseDir = "Univ-Bench";
	static String CompressBaseDir = "Univ-Bench-com";
	
	private static final String ub = "http://swat.cse.lehigh.edu/onto/univ-bench.owl#";
		...
		if(file.isFile()){
			...
			try {
				...
				while((line=bfr.readLine())!=null){
					line=line.replace(ub, "ub.").replace(rdf,"rdf.").replace(rdfs,"rdfs.").replace(owl, "owl.").replace("<","").replace(">","");
					bfw.write(line+"\n");
				}
				bfr.close();
				bfw.close();
